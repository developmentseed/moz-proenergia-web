...
export function Legend({ items, main, onMainOpacityChange }: LegendProps) {
  const { layers, activeLayers, toggleLayer, setLayerOpacity } =
    useContextualLayers();
  ...
  return (
    <>
      <Box
        ...
        minW="150px"
        maxH={{ base: "calc(100dvh - 16rem)", md: "calc(100dvh - 6rem)" }}
        overflowY="auto"
      >
        <Accordion.Root
          collapsible
        ...
        >
          <Accordion.Item value="legend" border="none">
            <Accordion.ItemTrigger
              ...
              borderBottomColor={["border", "transparent"]}
              borderRadius="none"
            >
              ...
              <VStack align="stretch" gap={2} pt={2}>
                <HStack w="full" align="center">
                  ...
                  <HStack gap={0} flexShrink={0}>
                    <OpacityControl
                      value={mainOpacity}
                      onValueChange={handleMainOpacity}
                    >
                      <IconButton
                        aria-label="Adjust main layer opacity"
                        size="2xs"
                        variant="ghost"
                      >
                        <LuDroplet />
